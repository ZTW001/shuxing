...
namespace Array
{
    class Program
    {
        ...
        {
            Console.WriteLine("Create an Array collection of Animal " + "objects and use it:");
            ...
            {
                Console.WriteLine("New {0} object add to Array collection," + "Name = {1}", myAnimal.ToString(), myAnimal.Name);
            }
